...
<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
      ...
      <!-- End Navbar -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <button onclick="showAddUserForm()">Add new Location</button>
    <table class="table table-responsive"  id="userTable">
        ...
        <tbody>
              ...
              <tr>
                <td><?= $courseatt->id; ?></td>
                <td><img src="DBOperations/Uploads/<?= $courseatt->imgpath; ?>" alt="" height="50px" width="50px"></td>
                <td><?= $courseatt->title; ?></td>
                <td><?= $courseatt->phonenumber; ?></td>

                <td>
                <button class="btn-sm" 
                data-id="<?= $courseatt->id; ?>"
                data-title="<?= $courseatt->title; ?>" 
                data-phonenumber="<?= $courseatt->phonenumber; ?>" 
      ...
      <button class="btn-sm"         
                      ...
                      <button class="btn-sm"         
                      data-id="<?= $courseatt->id; ?>"
                      onclick="showEditImageForm(this)">change picture</button>
                  </td>
              </tr><?php
                                              }
                                          }
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <label for="Imagelabel" id="Imagelabel" >Image :</label>
            <input type="file" name="Image" id="Image">

            <label for="titlelabel" id="titlelabel">title:</label>
            <input type="text"  id="title" name="title">

            <label for="phonenumberlabel" id="phonenumberlabel">phone number:</label>
...
function showEditUserForm(button){
  ...
  document.getElementById('formTitle').innerText = "Edit Location details";
  ...
  document.getElementById('addEditUserForm').action = 'DBOperations/edit_job.inc.php';
  document.getElementById('userForm').style.display = 'block';
...
function showEditImageForm(button) {
    ...
    document.getElementById('addEditUserForm').action = 'DBOperations/edit_courseImage.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
...
function deleteCourse(button) {
  var id = button.getAttribute('data-id');
    ...
    document.getElementById('formTitle').innerText = "Delete Location";
    document.getElementById('id').value = id;
  ...
  document.getElementById('addEditUserForm').action = 'DBOperations/deletejob.inc.php';
  document.getElementById('userForm').style.display = 'block';
}
const pages = {
            "users": "user.php",
