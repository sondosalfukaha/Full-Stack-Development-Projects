...
<body class="dark-edition" style="background-color:#000 !important;">
  <div class="wrapper" style="background-color: #000 !important;">
    <div class="sidebar"  style="background-color: #F99225 !important;">
      <div class="logo" style="background-color: #F99225 !important;"><a href="#" class="simple-text logo-normal">Admin</a>
    ...
    <div class="main-panel" style="background-color: #000 !important;">
      ...
      <nav  class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid" >
          ...
          <button  style="background-color: #F99225 !important;" class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation" data-target="#navigation-example">
            <span class="sr-only" style="background-color: #F99225 !important;">Toggle navigation</span>
          ...
          <div class="collapse navbar-collapse justify-content-end">              
            ...
            <li class="nav-item dropdown">
                ...
                <a  style="background-color: #F99225 !important;" class="dropdown-item" href="Order.php">new order is coming</a>
                <a  style="background-color: #F99225 !important;" class="dropdown-item" href="Location.php">Location is set</a>
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form action="DBOperations\add_new_user.inc.php" id="addEditUserForm" method="post">
                ...
                <label id="locationlable" for="location">Location:</label>
  ...
  <div class="fixed-plugin"  style="background-color: #F99225 !important;">
...
function deleteUser(button) {
    ...
    document.getElementById('locationlable').style.display='none'
    ...
    document.getElementById('locationlable').setAttribute("type", "hidden");
    document.getElementById('id').value = id;
