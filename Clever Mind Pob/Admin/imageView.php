    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Image View</a>
          </div>
      ...
      <div class="content row">
        <form action="includes/formhandler.inc.php" method="post">
          <div class="col-auto">
          <label for="h2">Main Title :</label>
          <input type="text" name="H2" id="h2"class="form-control" value="<?php 
          ...
          " >
                ...
                <br>
          <div class="col-auto">
          <label for="p">Main Paragraph :</label>
          <input type="text" name="P" id="p" class="form-control" value="<?php 
