  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Our Servers</a>
          </div>
      ...
      <div class="content row">
        <form action="includes/ourservers.inc.php" method="post">
          <div class="col-auto">
            <label for="tap1">Tap 1:</label>
            <input type="text" name="Tap1" id="tap1" class="form-control" value="<?php
          ...
          <br>
          <div class="col-auto">
          <label for="tap2">Tap 2:</label>
          <input type="text" name="Tap2" id="tap2" class="form-control" value="<?php
          ...
          <br>
          <div class="col-auto">
          <label for="tap3">Tap 3:</label>
          <input type="text" name="Tap3" id="tap3" class="form-control" value="<?php
