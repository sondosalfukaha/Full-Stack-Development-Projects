  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
        ...
        <div class="container-fluid">
          <div class="row">
            <button onclick="showAddUserForm()">Add new Feedback</button>
    <table class="table table-responsive"  id="userTable">
        ...
        <tbody>
              ...
              <tr>
                ...
                <td><?= $courseatt->feedback; ?></td>
                <td>
                <button class="btn-sm" 
                data-id="<?= $courseatt->id; ?>"
                data-userid="<?= $courseatt->userid; ?>"
                data-feedback="<?= $courseatt->feedback; ?>"
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <h2 id="formTitle">Add new feedback</h2>
            <form id="addEditUserForm" method="post" action="DBOperations/add_new_feedback.inc.php">
            ...
            <input type="text" id="id" name="id" hidden>
                ...
                <label for="feedback" id="feedbackLabel">Feedback:</label>
                <input type="title" id="feedback" name="feedback">
...
function showEditUserForm(button) {
    ...
    document.getElementById('formTitle').innerText = "Edit feedback details";
    document.getElementById('id').value = id;
    document.getElementById('userid').value = userid;
    document.getElementById('feedback').value = feedback;

    document.getElementById('addEditUserForm').action = 'DBOperations/edit_feedback.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
...
function deleteCourse(button) {
  var id = button.getAttribute('data-id');
  document.getElementById('formTitle').innerText = "Delete feedback";
  document.getElementById('id').value = id;
  document.getElementById('userid').setAttribute('type','hidden')
    document.getElementById('feedback').setAttribute('type','hidden')
    document.getElementById('useridLabel').style.display = 'none';
    document.getElementById('feedbackLabel').style.display = 'none';
   document.getElementById('addEditUserForm').action = 'DBOperations/delete_feedback.inc.php';
    document.getElementById('userForm').style.display = 'block';
