...
<body class="dark-edition">
  <div class="wrapper ">
    ...
    <table class="table table-responsive"  id="userTable">
        ...
        <tbody>
          <?php
          $sql = "SELECT * FROM TrainingCourses;";
          ...
          <tr>
            ...
            <td>
              <img src="DBOperations/Uploads/<?= $course->picture; ?>" alt="" height="50px" width="50px">
            </td>
            <td><?= $course->price; ?></td>
            <td>
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form action="DBOperations\add_new_course.inc.php" method="post" id="addEditUserForm" enctype="multipart/form-data">
                ...
                <!--
                <label for="currentImage" id="currentImagelable" hidden>Current Image:</label>
                <img id="currentImage" src="" alt="Current Image" style="width: 100px; height: auto;" hidden><br>
                                    -->
                ...
                <label for="price" id="pricelable">Price:</label>
...
function showEditUserForm(button) {
    ...
    document.getElementById('formTitle').innerText = "Edit course details";
...
function showEditImageForm(button) {
    ...
    var titlelable = document.getElementById('titlelable');
    titlelable.style.display = 'none';

    var price = document.getElementById('price');
    price.style.display = 'none';
    var pricelable = document.getElementById('pricelable');
    pricelable.style.display = 'none';
...
document.getElementById('formTitle').innerText = "Delete Course";
