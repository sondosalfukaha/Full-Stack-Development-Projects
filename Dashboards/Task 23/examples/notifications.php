  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
        ...
        <div class="container-fluid">
          <hr> 
          <h3 class="text-center">Notifications For All Users</h3>
          <div class="row">
            <button onclick="//showAddUserForm()">Add new Notify</button>
    <table class="table table-responsive"  id="userTable">
        ...
        <tbody class="text-center">
            ...
            <tr>
              <td>New Update</td>
              <td><button class="btn-success btn-sm">Notify all users</button></td>
              <td>
                <button class="btn-sm" onclick="editUser()">Edit</button>
                <button class="btn-sm" onclick="deleteUser()">Delete</button>
            </td>
            </tr>
            <tr>
              <td>New Even is coming</td>
              <td><button class="btn-success btn-sm">Notify all users</button></td>
              <td>
                <button class="btn-sm" onclick="editUser()">Edit</button>
                <button class="btn-sm" onclick="deleteUser()">Delete</button>
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
          ...
          <br>
          <hr> 
          <h3 class="text-center">Notifications For specific Users</h3>
          <div class="row">
            <button onclick="//showAddUserForm()">Add new Notify</button>
    <table class="table table-responsive"  id="userTable">
        <thead>
            <tr class="text-center">
                <th>User Id</th>
                <th>Update Notification</th>
                <th>Event Notification</th>
                <th>New Course Notification</th>
            </tr>
        </thead>
        <tbody class="text-center">
            <!-- User rows will be dynamically added here -->
            <tr>
              <td>101</td>
              <td><button class="btn-success btn-sm">Notify</button></td>
              <td><button class="btn-success btn-sm">Notify</button></td>
              <td><button class="btn-success btn-sm">Notify</button></td>
            </tr>
            <tr>
...
document.addEventListener('DOMContentLoaded', () => {
    loadUsers();
    document.getElementById('addEditUserForm').addEventListener('submit', saveUser);
});

function loadUsers() {
    // Load user data from your backend or a placeholder for now
...
function saveUser(event) {
    ...
    if (userId) {
        ...
        console.log('Updating user:', { userId, fullName, email, username, phoneNumber, dob });
    } else {
        // Add user logic here
        console.log('Adding user:', { fullName, email, username, phoneNumber, dob });
    }
    closeUserForm();
    loadUsers();
}
...
function editUser(id) {
    ...
    const user = { id: id, fullName: 'John Doe', email: 'john@example.com', username: 'johndoe', phoneNumber: '1234567890', dob: '1990-01-01' };
