  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
        ...
        <div class="container-fluid">
          <div class="row">
            <button onclick="showAddUserForm()">Add new Policy</button>
    <table class="table table-responsive"  id="userTable">
        ...
        <tbody>
          <?php
          $sql = "SELECT * FROM policyandprivacy;";
          ...
          <tr>
            ...
            <td><?= $courseatt->id; ?></td>
            <td><?= $courseatt->text; ?></td>
            <td>
            <button class="btn-sm" 
            data-id="<?= $courseatt->id; ?>"
            data-text="<?= $courseatt->text; ?>"
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form id="addEditUserForm" method="post" action="DBOperations/add_new_policyandprivacy.inc.php">

                <input type="text" name="id" id="id" hidden>

                <label for="text" id="textl">Text:</label>
...
function showEditUserForm(button) {
    ...
    document.getElementById('formTitle').innerText = "Edit policy&privacy details";
    document.getElementById('id').value = id;
    document.getElementById('text').value = text;

    document.getElementById('addEditUserForm').action = 'DBOperations/edit_policyandprivacy.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
...
function deleteCourse(button) {
  var id = button.getAttribute('data-id');
  document.getElementById('formTitle').innerText = "Delete policyandprivacy";
  document.getElementById('id').value = id;
  document.getElementById('text').setAttribute('type','hidden')
    document.getElementById('textl').style.display = 'none';
   document.getElementById('addEditUserForm').action = 'DBOperations/delete_policyandprivacy.inc.php';
    document.getElementById('userForm').style.display = 'block';
