...
<body class="dark-edition" style="background-color: #fff !important;">
  <div class="wrapper "style="background-color: #fff !important;">
    ...
    <table class="table table-responsive"  id="userTable">
        ...
        <tbody>
        <?php
        $sql = "SELECT * FROM discountedfruits;";
...
<button class="btn-sm" 
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form  action="DBOperations\add_new_dicfruit.inc.php" method="post" id="addEditUserForm" enctype="multipart/form-data">
...
function showAddUserForm() {
    ...
    document.getElementById('formTitle').textContent = 'Add new fruit';
