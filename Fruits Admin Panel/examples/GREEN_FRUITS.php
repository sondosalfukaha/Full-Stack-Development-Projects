  ...
  <div class="wrapper "style="background-color: #fff !important;">
    ...
    <div class="main-panel" style="background-color: #fff !important;">
      ...
      <!-- End Navbar -->
        ...
        <div class="container-fluid">
          <div class="row">
            <button onclick="showAddUserForm()">Add new Fruit</button>
...
function showEditUserForm(button) {
  ...
  document.getElementById('imagelabel').style.display="none";
    ...
    document.getElementById('addEditUserForm').action = 'DBOperations/edit_greenfruit.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
function showEditPicture(button) {
  ...
  document.getElementById('imagelabel').style.display="block";
    ...
    document.getElementById('addEditUserForm').action = 'DBOperations/edit_newImagegreenfruit.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
...
function deleteCourse(button) {
  ...
  document.getElementById('addEditUserForm').action = 'DBOperations/deletenew4.inc.php';
  document.getElementById('userForm').style.display = 'block';
}
