...
<button class="btn-sm" 
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form  action="DBOperations\add_new_fruit.inc.php" method="post" id="addEditUserForm" enctype="multipart/form-data">
...
function showEditUserForm(button) {
    ...
    document.getElementById('addEditUserForm').action = 'DBOperations/edit_summerfruits.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
...
function showEditPicture(button) {
    ...
    document.getElementById('addEditUserForm').action = 'DBOperations/edit_newImagesummerfruit.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
...
function deleteCourse(button) {
  ...
  document.getElementById('addEditUserForm').action = 'DBOperations/deletenew3.inc.php';
  document.getElementById('userForm').style.display = 'block';
}
