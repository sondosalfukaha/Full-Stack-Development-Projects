  ...
  <div class="wrapper" style="background-color: #fff !important;">
    <div class="sidebar"  style="background-color: #1acbcc !important;">
      ...
      <div class="sidebar-wrapper"  style="background-color: #1acbcc !important;">
        <ul class="nav" id='list'>
          ...
          <li class="nav-item">
            <a class="nav-link" href="./NEW FRUITS">
    ...
    <div class="main-panel" style="background-color: #fff !important;">
      ...
      <div class="content row" style="z-index: 100;">
        <div class="container-fluid">
          <div class="row">
            <button onclick="showAddUserForm()">Add new Order</button>
    <table class="table table-responsive"  id="userTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            data-visaorcash="<?= $course->visaorcash; ?>"
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form action="DBOperations\add_new_course.inc.php" method="post" id="addEditUserForm" enctype="multipart/form-data">
                ...
                <label for="visaorcashlabel" id="visaorcashlabel">visa or cash:</label>
                <input type="text" id="visaorcash" name="visaorcash">
...
function showEditUserForm(button) {
    ...
    var visaorcash = button.getAttribute('data-visaorcash');
    ...
    document.getElementById('visaorcash').value = visaorcash;
...
document.getElementById('formTitle').innerText = "Delete Order";
    ...
    var visaorcashlabel = document.getElementById('visaorcashlabel');
    visaorcashlabel.style.display = 'none';
    ...
    document.getElementById('visaorcash').setAttribute("type", "hidden");
