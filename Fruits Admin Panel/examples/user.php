...
<body class="dark-edition" style="background-color:#fff !important;">
  <div class="wrapper" style="background-color: #fff !important;">
    <div class="sidebar"  style="background-color: #1acbcc !important;">
      <div class="logo" style="background-color: #1acbcc !important;"><a href="#" class="simple-text logo-normal">Admin</a>
    ...
    <div class="main-panel" style="background-color: #fff !important;">
      ...
      <nav  class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid" >
          ...
          <button  style="background-color: #1acbcc !important;" class="navbar-toggler" type="button" data-toggle="collapse" aria-controls="navigation-index" aria-expanded="false" aria-label="Toggle navigation" data-target="#navigation-example">
            <span class="sr-only" style="background-color: #1acbcc !important;">Toggle navigation</span>
          ...
          <div class="collapse navbar-collapse justify-content-end">              
            ...
            <li class="nav-item dropdown">
                ...
                <a  style="background-color: #1acbcc !important;" class="dropdown-item" href="Order.php">new order is coming</a>
                <a  style="background-color: #1acbcc !important;" class="dropdown-item" href="Location.php">Location is set</a>
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form action="DBOperations\add_new_user.inc.php" id="addEditUserForm" method="post">
                <input type="text" id="id" name="id" hidden>
                
                <label id="fullnamelable" for="fullName">Full Name:</label>
                <input type="text" id="fullName" name="fullName">

                <label id="emaillable" for="email">Email:</label>
                <input type="email" id="email" name="email">

                <label id="usernamelable" for="username">Username:</label>
                <input type="text" id="username" name="username">

                <label id="phonenumberlable" for="phoneNumber">Phone Number:</label>
                <input type="text" id="phoneNumber" name="phoneNumber">

                <label id="Paymentlable" for="Payment">Payment:</label>
                <input type="text" id="Payment" name="Payment">

                

                <p id="AreYouSureForDeleteaction"></p>
                <button type="submit" name="save_user" id="Deletebutton">Save</button>
            </form>
        </div>
    </div>
          </div>
  ...
  <div class="fixed-plugin"  style="background-color: #1acbcc !important;">
...
function showEditUserForm(button) {
    ...
    document.getElementById('addEditUserForm').action = 'DBOperations/edit_user.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
...
function deleteUser(button) {
    ...
    var id = button.getAttribute('data-id');
    document.getElementById('formTitle').innerText = "Delete User";

    document.getElementById('fullName').setAttribute("type", "hidden");
    ...
    document.getElementById('Payment').setAttribute("type", "hidden");

    document.getElementById('fullnamelable').style.display='none'
    document.getElementById('emaillable').style.display='none'
    document.getElementById('usernamelable').style.display='none'
    document.getElementById('phonenumberlable').style.display='none'
    document.getElementById('Paymentlable').style.display='none'
    ...
    document.getElementById('id').value = id;
    document.getElementById('addEditUserForm').action = 'DBOperations/delete.inc.php';
    document.getElementById('userForm').style.display = 'block';
}
