...
<body class="dark-edition">
  <div class="wrapper ">
    ...
    <table class="table table-responsive"  id="userTable">
        ...
        <tr>
          <td><?= $new->new; ?></td>
          <td><?= $new->dexcription; ?></td>
          <td><img src="DBOperations/Uploads/<?= $new->image; ?>" alt="" height="50px" width="50px"></td>
          <td>
            <button class="btn-sm" 
                data-id="<?= $new->id; ?>"
                data-new="<?= $new->new; ?>" 
                data-desc="<?= $new->dexcription; ?>" 
                onclick="showEditUserForm(this)">Edit
              </button>
                ...
                <button class="btn-sm"
                data-id="<?= $new->id; ?>"
                onclick="showEditImageForm(this)">
                change picture
                </button>
            </td>
        </tr><?php
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form  action="DBOperations\add_new_new.inc.php" method="post" id="addEditUserForm" enctype="multipart/form-data">
              ...
              <label for="New" id="newlabel">New:</label>
              <input type="text" id="New" name="New">

              <label for="Dexcription" id="desclable">Dexcription:</label>
              <input type="text" id="Dexcription" name="Dexcription">

              <label for="Image" id="imglable">Image:</label>
...
function showEditUserForm(button) {
    ...
    var New = button.getAttribute('data-new');
    var dexcription = button.getAttribute('data-desc');
    
    document.getElementById('formTitle').innerText = "Edit New details";
    document.getElementById('id').value = id;
    document.getElementById('New').value = New;
    document.getElementById('Dexcription').value = dexcription;
    
    var image = document.getElementById('Image');
    image.style.display = 'none';
    var imglable = document.getElementById('imglable');
...
function deleteCourse(button) {
  var id = button.getAttribute('data-id');
    ...
    document.getElementById('formTitle').innerText = "Delete New";
    document.getElementById('id').value = id;
