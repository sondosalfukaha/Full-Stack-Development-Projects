  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
        ...
        <div class="container-fluid">
          <div class="row">
            <button onclick="showAddUserForm()">Add new job</button>
    <table class="table table-responsive"  id="userTable">
        ...
        <tbody>
              ...
              <td><?= $courseatt->id; ?></td>
                ...
                <td><?= $courseatt->experience; ?></td>
                <td><img src="DBOperations/Uploads/<?= $courseatt->picture; ?>" alt="" height="50px" width="50px"></td>
                <td><embed src="DBOperations/Uploads/<?= $courseatt->cv; ?>" alt="" height="200px" width="200px"></td>
    ...
    <div id="userForm" class="modal">
        <div class="modal-content">
            ...
            <form id="addEditUserForm" method="post" enctype="multipart/form-data" action="DBOperations\add_new_job.inc.php">
                ...
                <label for="cv" id="cvlabel">CV:</label>
...
function deleteCourse(button) {
  ...
  document.getElementById('formTitle').innerText = "Delete job";
  document.getElementById('id').value = id;
  document.getElementById('titlelabel').style.display = 'none'
  document.getElementById('Experiencelabel').style.display = 'none'
  ...
  document.getElementById('Experience').setAttribute('type','hidden')
  document.getElementById('Image').setAttribute('type','hidden')
  document.getElementById('cv').setAttribute('type','hidden')
