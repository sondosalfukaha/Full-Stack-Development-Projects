...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a class="active" title="Name" href="Email.php"><span class="mini-sub-pro">Email</span></a></li>
    ...
    <form action="includes/EmailHANDLER.inc.php" method="POST" class="phoneform">
          <label for="Email">Change Email</label>
          <span style="margin-bottom:10px">info@clevermindpob.org</span>
