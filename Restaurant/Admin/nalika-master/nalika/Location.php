...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Name" href="Email.php"><span class="mini-sub-pro">Email</span></a></li>
                                <li><a class="active" title="Location" href="Location.php"><span class="mini-sub-pro">Location</span></a></li>
                            </ul>
                        </li>
                        <li>
    ...
    <form action="includes/LocationHANDLER.inc.php" method="POST" class="phoneform">
          <label for="Email">Change Location</label>
          <span style="margin-bottom:10px">Amman-Jordan</span>
