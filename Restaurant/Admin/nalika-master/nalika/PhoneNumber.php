...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a class="active"  title="Phone Number" href="PhoneNumber.php"><span class="mini-sub-pro">Phone Number</span></a></li>
    ...
    <div class="all-content-wrapper">
        <div class="container-fluid">
          <form action="includes/PhoneNHANDLER.inc.php" method="POST" class="phoneform">
