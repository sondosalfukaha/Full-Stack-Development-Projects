...
<body>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li class="active"><a href="Recipe1.php"><span class="mini-sub-pro">Recipe 1</span></a></li>
    ...
    <div class="container-fluid">
            <h1>Recipe 1</h1>
            <form action="includes/recipe1Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
                <div class="main" style="margin-left: 50px;">
                    ...
                    <div class="description divi">
                        <input type="text" name="Rec_Name" id="desc" class="larg-pad" placeholder="Recipe Name" value="<?php
                    ...
                    <div class="text divi">
                        <input type="text" name="cost" id="title" placeholder="Cost" class="smal-pad" value="<?php 
