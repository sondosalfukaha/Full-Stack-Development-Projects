...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li class="active"><a href="Recipe2.php"><span class="mini-sub-pro">Recipe 2</span></a></li>
    ...
    <div class="all-content-wrapper">
        ...
        <h1>Recipe 2</h1>
            <form action="includes/recipe2Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
