...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li  class="active"><a href="Recipe3.php"><span class="mini-sub-pro">Recipe 3</span></a></li>
    ...
    <div class="all-content-wrapper">
        ...
        <h1>Recipe 3</h1>
            <form action="includes/recipe3Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
