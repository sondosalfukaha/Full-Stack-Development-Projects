...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li class="active"><a href="Recipe4.php"><span class="mini-sub-pro">Recipe 4</span></a></li>
    ...
    <div class="all-content-wrapper">
        ...
        <h1>Recipe 4</h1>
            <form action="includes/recipe4Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
