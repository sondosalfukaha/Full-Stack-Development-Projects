...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li  class="active"><a href="Recipe5.php"><span class="mini-sub-pro">Recipe 5</span></a></li>
                            </ul>
                        </li>
                        <li>
    ...
    <div class="container-fluid">
        <h1>Recipe 5</h1>
            <form action="includes/recipe5Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
