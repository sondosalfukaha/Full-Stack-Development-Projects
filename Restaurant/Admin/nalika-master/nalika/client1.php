...
<body>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li class="active"><a href="client1.php"><span class="mini-sub-pro">Client 1</span></a></li>
    ...
    <div class="all-content-wrapper">
        ...
        <h1>Client 1</h1>
            <form action="includes/client1Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
