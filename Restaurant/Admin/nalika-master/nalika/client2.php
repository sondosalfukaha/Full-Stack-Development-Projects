...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li class="active"><a href="client2.php"><span class="mini-sub-pro">Client 2</span></a></li>
    ...
    <div class="all-content-wrapper">
        ...
        <h1>Client 2</h1>
            <form action="includes/client2Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
