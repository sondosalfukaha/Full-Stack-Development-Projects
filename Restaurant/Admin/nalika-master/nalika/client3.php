...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li class="active"><a href="client3.php"><span class="mini-sub-pro">Client 3</span></a></li>
                            </ul>
                        </li>
                        <li>
                                <a href="index5.php">
    ...
    <div class="all-content-wrapper">
        ...
        <h1>Client 3</h1>
        <form action="includes/client3Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
                <div class="main" style="margin-left: 50px;">
                    ...
                    <div class="description divi">
                        <input type="text" name="Name" id="desc" class="larg-pad" placeholder="Client Name" value="<?php
                    ...
                    <div class="text divi">
                        <input type="text" name="feedback" id="title" placeholder="Client Feedback" class="smal-pad" value="<?php 
                        $sql = "SELECT `Feedback` FROM `client3` WHERE 1;";
                        $result = $con->prepare($sql);
                        $result->execute();
                        $resultCheck = $result->rowCount();
                        if ($resultCheck > 0) {
