...
<body>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li class="active"><a title="Fav Icon" href="slide1.php"><span class="mini-sub-pro">Slide 1</span></a></li>
    ...
    <div class="all-content-wrapper">
        <div class="container-fluid">
            <h1>Slide 1</h1>
            <form action="includes/slide1Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
