...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li class="active"><a title="Title" href="slide2.php"><span class="mini-sub-pro">Slide 2</span></a></li>
    ...
    <div class="all-content-wrapper">
        <div class="container-fluid">
            <h1>Slide 2</h1>
            <form action="includes/slide2Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
