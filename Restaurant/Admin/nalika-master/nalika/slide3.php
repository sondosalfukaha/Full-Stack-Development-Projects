...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li class="active"><a title="Phone Number" href="slide3.php"><span class="mini-sub-pro">Slide 3</span></a></li>
                            </ul>
                        </li>
                        <li>
    ...
    <div class="all-content-wrapper">
        <div class="container-fluid">
            <h1>Slide 3</h1>
            <form action="includes/slide3Handler.inc.php" method="POST" enctype="multipart/form-data" class="slidee">
                <div class="main">
                    ...
                    <div class="description divi">
                        <input type="text" name="description" id="desc" class="larg-pad" placeholder="Description" value="<?php
                    ...
                    <div class="text divi">
                        <input type="text" name="title" id="title" placeholder="Title" class="smal-pad" value="<?php 
